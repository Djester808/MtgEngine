...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MtgEngine.Domain.Models.AiResponseCache", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("Kind", "CacheKey", "ModelVersion")
                        .IsUnique();

                    b.ToTable("AiResponseCache");
                });

            modelBuilder.Entity("MtgEngine.Domain.Models.CardPriceSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("ScryfallId", "CapturedAt")
                        .IsUnique();

                    b.ToTable("CardPriceSnapshots");
                });
            ...
            modelBuilder.Entity("MtgEngine.Domain.Models.CardSynergyScore", b =>
                {
                    ...
                    b.HasIndex("CommanderOracleId", "CardOracleId", "ModelVersion")
                        .IsUnique();
            ...
            modelBuilder.Entity("MtgEngine.Domain.Models.CollectionCard", b =>
                {
                    ...
                    b.Property<decimal?>("PriceUsdAtAdd")
                        .HasColumnType("TEXT");

                    b.Property<decimal?>("PriceUsdFoilAtAdd")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MtgEngine.Domain.Models.CollectionCardEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<Guid?>("CounterpartCollectionId")
                        .HasColumnType("TEXT");

                    b.Property<string>("CounterpartCollectionName")
                        .HasMaxLength(256)
                        .HasColumnType("TEXT");
                    ...
                    b.Property<int>("QuantityFoilAfter")
                        .HasColumnType("INTEGER");

                    b.Property<int>("QuantityFoilDelta")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("UserId", "OracleId", "CreatedAt");

                    b.ToTable("CollectionCardEvents");
                });
            ...
            modelBuilder.Entity("MtgEngine.Domain.Models.User", b =>
                {
                    ...
                    b.Property<string>("FavoriteCommanderOracleId")
                        .HasMaxLength(64)
                        .HasColumnType("TEXT");

                    b.Property<string>("FavoriteFormat")
                        .HasMaxLength(32)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MtgEngine.Domain.Models.UserAvatar", b =>
                {
                    b.HasOne("MtgEngine.Domain.Models.User", null)
                        .WithOne()
                        .HasForeignKey("MtgEngine.Domain.Models.UserAvatar", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
